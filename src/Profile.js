    ...
    render(){
        return(
            <div className='profile'>
                ...
                <h1 className='polls' style={{'margin-top': 10, 'font-variant': 'small-caps'}}>{this.props.user.username}</h1>
                <h2 className='pollHeader' style={{'margin-top':10,'margin-bottom':10, 'width':'20%'}}>Polls</h2>
